...
a(education, [graduate, not_graduate, nil]). % Livello di istruzione (Graduate, Not Graduate, NIL)
a(self_employed, [yes, no, nil]). % Lavoratore autonomo (Yes, No, NIL)
a(applicantincome, [low, medium_low, medium, medium_high, high, very_high, null]). % Reddito richiedente
a(coapplicantincome, [null, low, medium_low, medium, medium_high, high]). % Reddito co-richiedente
a(loanamount, [low, medium_low, medium, medium_high, high, very_high, nil]). % Importo del prestito
...
a(property_area, [urban, semiurban, rural, nil]). % Area della proprietà
